...
Begin VB.Form FrmCheckInShow 
   ...
   Begin VB.ListBox List4 
      ...
      BackColor       =   &H0080C0FF&
      Height          =   5490
      ItemData        =   "FrmCheckInShow.frx":0000
      Left            =   5640
      List            =   "FrmCheckInShow.frx":0002
      TabIndex        =   5
      Top             =   1320
      Width           =   2055
   End
   Begin VB.ListBox List3 
      ...
      BackColor       =   &H0080C0FF&
      Height          =   5490
      ItemData        =   "FrmCheckInShow.frx":0004
      Left            =   3600
      List            =   "FrmCheckInShow.frx":0006
      TabIndex        =   4
      Top             =   1320
      Width           =   2055
   End
   ...
   Begin VB.ListBox List2 
      ...
      BackColor       =   &H0080C0FF&
      Height          =   5490
      ItemData        =   "FrmCheckInShow.frx":0008
      Left            =   1920
      List            =   "FrmCheckInShow.frx":000A
      TabIndex        =   2
      Top             =   1320
      Width           =   1695
   End
   Begin VB.ListBox List1 
      ...
      BackColor       =   &H0080C0FF&
      Height          =   5490
      ItemData        =   "FrmCheckInShow.frx":000C
      Left            =   360
      List            =   "FrmCheckInShow.frx":000E
      TabIndex        =   1
      Top             =   1320
      Width           =   1575
   End
   Begin VB.ListBox List5 
      ...
      BackColor       =   &H0080C0FF&
      Height          =   5490
      ItemData        =   "FrmCheckInShow.frx":0010
      Left            =   7680
      List            =   "FrmCheckInShow.frx":0012
      TabIndex        =   0
      Top             =   1320
      Width           =   3135
   End
   ...
   End
End
Attribute VB_Name = "FrmCheckInShow"
